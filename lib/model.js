...
(function() {
  var Application, Domain, Model, Q, Sequelize, User, async, config, db, expandHomeDir, fs, logger, md5, storagePath, validator;
  ...
  Model = (function() {
    ...
    Model.prototype.getApplicationForHostname = function(hostname, callback) {
      return Domain.findAll({
        ...
        if (!domain) {
          return callback(new Error('no application found for domain ' + domain));
        }
